...
_(se completa a medida que se implementan los scripts)_

| Script | Genera | Sección del documento |
| --- | --- | --- |
| `scripts/01_verify_heston_limit.py` | — | Verificación |
| `scripts/02_verify_semimc.py` | — | Verificación |
| `scripts/03_figs_articulo.py` | — | Verificación |
| `scripts/04_numerical_analysis.py` | — | Discusión (análisis numérico) |
| `scripts/05_get_data.py` | `data/raw/`, `data/processed/` | Datos |
| `scripts/06_calibrate.py` | `results/tables/` | Calibración |
| `scripts/07_make_all.py` | todo | — |
